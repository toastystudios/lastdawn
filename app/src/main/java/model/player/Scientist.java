 ...
 */
public class Scientist extends PlayerChar implements model.character.BattleMoves {
    ...
    public Scientist(String name) {
        super(name, Scientist.class.getSimpleName(), BASE_CONSTITUTION, BASE_STRENGTH, BASE_INTELLIGENCE, BASE_DEXTERITY);
    }
    ...
    public int basicAttack() {
        ...
        return (int) NumberUtils.roundDown(((stats.intelligence()+ inventory.equipmentStats().get(StatTypes.INTELLIGENCE.toString())) * MODIFIER) + inventory.weaponDamage());
    }
