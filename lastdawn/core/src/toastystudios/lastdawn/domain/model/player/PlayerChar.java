...
import toastystudios.lastdawn.domain.model.character.ResourceManager;
 ...
 */
public abstract class PlayerChar extends Character {
     ...
     * @return
     */
    private int experienceGained(Character enemy) {
     ...
     * @return
     */
    public int increaseXP(Character enemy) {
